...
description: "A practical guide to navigating common TensorRT pitfalls and achieving production-ready deployments."
...
Always check out the NVIDIA [Support Matrix](https://docs.nvidia.com/deeplearning/tensorrt/latest/getting-started/support-matrix.html) before getting started.[^1]
...
Keep in mind the tensor shape for torch's SDPA is different: $(batch, nheads, seqlen, headdim)$ compared to FA2/FA3 $(batch, seqlen, nheads, headdim)$.[^2]
...
While newer ONNX opsets support conditional operations, TensorRT's static nature still imposes this limitation.[^3]
